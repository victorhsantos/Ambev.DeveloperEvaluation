...
{
    public static class AddSaleHandlerTestData
    {
        ...
        private static readonly Faker<AddSaleCommand> AddSaleFaker = new Faker<AddSaleCommand>()
        ...
        public static AddSaleCommand GenerateAddSaleCommand()
        {
            return AddSaleFaker.Generate();
        }
    }
}
